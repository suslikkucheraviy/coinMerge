"""
Django settings for nickgameDjango project.
...
SECRET_KEY = 'django-insecure-l%=0h#ah#-=t&w=m-lvyro3*o6vt@2jjs=wr)6$y$r==q35kx@'
...
ROOT_URLCONF = 'nickgameDjango.urls'
...
WSGI_APPLICATION = 'nickgameDjango.wsgi.application'
